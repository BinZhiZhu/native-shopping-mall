...
if(!empty($_REQUEST['submit'])){
    ...
    {
        echo "<script language=javascript>alert('注册失败，该用户名已经存在');window.location.href='register.php';</script>";
        exit;
    ...
    ('$username','$password',2,'$name','$tel','$address','$ctime')";
...
<form action="register.php?submit=1" method="post" onsubmit="return checkform()">
    	...
    	<td>
    	<input type="text" name="username" style="width: 300px;height: 25px;"   id="usernameid" />
    	</td>
    	</tr>
    	...
    	<td>
    	<input type="password" name="password" style="width: 300px;height: 25px;" id="passwordid" />
    	</td>
    	</tr>
    	...
    	<td>
    	<input type="password" name="password2" style="width: 300px;height: 25px;" id="password2id" />
    	</td>
    	</tr>
    	...
    	<td >  
    	<input type="submit" id="submitid" value="&nbsp;注&nbsp;&nbsp;册&nbsp;" style="width: 100px;height: 30px;" />
    	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
