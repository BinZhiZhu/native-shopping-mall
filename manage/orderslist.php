...
<input type="submit" value="&nbsp;搜&nbsp;索&nbsp;" style="width: 60px;">
  ...
  <tbody>
    ...
    foreach ($dataArray as $value){
	  ...
	  <a href="ordersupdate3.php?Id=<?php echo $value['Id'];?>"><span style="font-size: 12px;">查看订单详情</span></a>
      &nbsp;

      <a href="ordersdelete.php?Id=<?php echo $value['Id'];?>" onclick="return confirm('确定要发货吗?'); ">
      <span style="font-size: 12px;">发货</span></a>
      &nbsp;
