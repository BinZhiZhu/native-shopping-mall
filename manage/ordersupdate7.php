...
<table class="usertableborder" cellspacing="1" cellpadding="3" width="96%" align="center"
    ...
    <br>
    <form method="post"   action="ordersdelete2.php?submit=1&Id=<?php echo $Id;?>"  onsubmit="return checkform()"  enctype="multipart/form-data">
  ...
  <tbody>
    ...
    <tr>
     ...
     <tr>
      ...
      <td>
       &nbsp; &nbsp; &nbsp; &nbsp;
      <input type="submit" id="submitid"  value="&nbsp;&nbsp;退&nbsp;&nbsp;货&nbsp;&nbsp;" style="width: 80px;"/>
      &nbsp; &nbsp; &nbsp; &nbsp;
